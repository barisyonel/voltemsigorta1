                                    ...
                                    <div className="portfolio-one__img-box">
                                        ...
                                        <div className="portfolio-one__content">
                                            ...
                                            <div className="portfolio-one__title-box">
                                                ...
                                                <h3 className="portfolio-one__title"><Link href="portfoy-detay">Health
                                                        Analytics</Link></h3>
                                            </div>
                                ...
                                <div className="portfolio-one__single">
                                    <div className="portfolio-one__img-box">
                                        ...
                                        <div className="portfolio-one__content">
                                            ...
                                            <div className="portfolio-one__title-box">
                                                <p className="portfolio-one__sub-title">San Fransisco</p>
                                                <h3 className="portfolio-one__title"><Link href="portfoy-detay">Insurance
                                                        Analytics</Link></h3>
                                            </div>
                                            <div className="portfolio-one__arrow">
                                ...
                                <div className="portfolio-one__single">
                                    <div className="portfolio-one__img-box">
                                        ...
                                        <div className="portfolio-one__content">
                                            ...
                                            <div className="portfolio-one__title-box">
                                                <p className="portfolio-one__sub-title">San Fransisco</p>
                                                <h3 className="portfolio-one__title"><Link href="portfoy-detay">Travels
                                                        Analytics</Link></h3>
                                            </div>
                                            <div className="portfolio-one__arrow">
                                ...
                                <div className="portfolio-one__single">
                                    <div className="portfolio-one__img-box">
                                        ...
                                        <div className="portfolio-one__content">
                                            ...
                                            <div className="portfolio-one__title-box">
                                                <p className="portfolio-one__sub-title">San Fransisco</p>
                                                <h3 className="portfolio-one__title"><Link href="portfoy-detay">Life
                                                        Analytics</Link></h3>
                                            </div>
                                            <div className="portfolio-one__arrow">
