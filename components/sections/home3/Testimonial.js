        ...
        <section className="testimonial-one testimonial-two">
            <div className="container">
                <div className="section-title text-center">
                    ...
                    <h2 className="section-title__title">Clients Feedback Already
                        <br/> They Gived Us</h2>
                </div>
                        ...
                        <div className="item">
                            <div className="testimonial-one__single">
                                ...
                                <div className="testimonial-one__client-info">
                                    ...
                                    <h3 className="testimonial-one__client-name"><Link href="yorumlar">Ononto Khan</Link>
                                    </h3>
                        ...
                        <div className="item">
                            <div className="testimonial-one__single">
                                ...
                                <div className="testimonial-one__client-info">
                                    ...
                                    <h3 className="testimonial-one__client-name"><Link href="yorumlar">Smith S.R</Link>
                                    </h3>
                                    <p className="testimonial-one__client-sub-title">Developer</p>
                                </div>
                            </div>
                        ...
                        <div className="item">
                            <div className="testimonial-one__single">
                                ...
                                <div className="testimonial-one__client-info">
                                    ...
                                    <h3 className="testimonial-one__client-name"><Link href="yorumlar">Alisha
                                            Martin</Link></h3>
                                    <p className="testimonial-one__client-sub-title">Developer</p>
                                </div>
                            </div>
                        ...
                        <div className="item">
                            <div className="testimonial-one__single">
                                ...
                                <div className="testimonial-one__client-info">
                                    ...
                                    <h3 className="testimonial-one__client-name"><Link href="yorumlar">David Koper</Link>
                                    </h3>
                                    <p className="testimonial-one__client-sub-title">Developer</p>
                                </div>
                            </div>
                        ...
                        <div className="item">
                            <div className="testimonial-one__single">
                                ...
                                <div className="testimonial-one__client-info">
                                    ...
                                    <h3 className="testimonial-one__client-name"><Link href="yorumlar">Jecika Brown</Link>
                                    </h3>
                                    <p className="testimonial-one__client-sub-title">Developer</p>
                                </div>
                            </div>
                        ...
                        <div className="item">
                            <div className="testimonial-one__single">
                                ...
                                <div className="testimonial-one__client-info">
                                    ...
                                    <h3 className="testimonial-one__client-name"><Link href="yorumlar">Harbert
                                            Spenser</Link></h3>
                                    <p className="testimonial-one__client-sub-title">Developer</p>
                                </div>
                            </div>
