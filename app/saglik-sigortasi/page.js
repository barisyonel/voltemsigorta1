...
export default function Home() {
    ...
    return (
        ...
        <Layout
            headerStyle={1}
            footerStyle={1}
            breadcrumbTitle="Sağlık Sigortası"
            breadcrumbImage="/tamamlayici-1920x520.jpeg"
            hideBreadcrumbText
        >
                ...
                <div className="row">
                    <div className="col-xl-8 col-lg-7">
                        <div className="insurance-details__left">
                            ...
                            <p className="insurance-details__text-1">Voldem Sigorta Tokat, sağlık sigortasında ihtiyaçlarınıza
                            ...
                            <p className="insurance-details__text-2">Sağlık sigortası, tedavi ve bakım süreçlerinde
                                bütçenizi korur. Kapsamlı teminatlarla yanınızdayız.</p>
                                ...
                                <div className="accrodion-grp faq-one-accrodion" data-grp-name="faq-one-accrodion-1">
                                    <div className={isActive.key == 1 ? "accrodion active" : "accrodion"} onClick={() => handleToggle(1)}>
                                        <div className="accrodion-title">
                                            <h4>Sağlık sigortası neleri kapsar?</h4>
                                        </div>
