export const metadata = {
    ...
    keywords: [
        ...
        "tokat sağlık sigortası fiyatları",
    ],
    openGraph: {
        title: "Sağlık Sigortası | Voldem Sigorta Tokat",
        description: "Tokat sağlık sigortası çözümleri. TARSIM ve özel sağlık sigortası ile güvende kalın.",
        images: [
            {
    ...
    alternates: {
        canonical: "/saglik-sigortasi",
    },
}

export default function SaglikSigortasiLayout({ children }) {
    return <>{children}</>
}
