...
export default function Home() {
    ...
    return (
        <>
        <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Hayat Sigortası">
                ...
                <div className="row">
                    <div className="col-xl-8 col-lg-7">
                        <div className="insurance-details__left">
                            ...
                            <p className="insurance-details__text-1">Voldem Sigorta Tokat, hayat sigortasında ihtiyacınıza
                                uygun teminatları bir araya getirir. Güvenli, hızlı ve şeffaf bir süreç sunarız.</p>
                            <div className="insurance-details__img-1">
                                <img src="assets/images/hayat.png" alt=""/>
                            </div>
                            <h3 className="insurance-details__title-2">Hayat Sigortası</h3>
                            <p className="insurance-details__text-2">Hayat sigortası, ailenizi ve geleceğinizi güvence
                                altına alır. Bütçenize uygun seçeneklerle kapsamlı teminatlar sunuyoruz.</p>
                                ...
                                <div className="accrodion-grp faq-one-accrodion" data-grp-name="faq-one-accrodion-1">
                                    <div className={isActive.key == 1 ? "accrodion active" : "accrodion"} onClick={() => handleToggle(1)}>
                                        <div className="accrodion-title">
                                            <h4>Hayat sigortası hangi riskleri kapsar?</h4>
                                        </div>
