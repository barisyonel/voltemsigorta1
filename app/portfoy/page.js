...
export const metadata = {
    title: "Portföy | Voldem Sigorta Tokat",
    description: "Voldem Sigorta Tokat projeleri ve portföy çalışmaları.",
                        ...
                        <div className="portfolio-three__single">
                            <div className="portfolio-three__img-box">
                                ...
                                <div className="portfolio-three__content">
                                    ...
                                    <h3 className="portfolio-three__title"><Link href="portfoy-detay">Digital
                                            Insurance</Link></h3>
                                </div>
