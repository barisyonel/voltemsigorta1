...
export default function Home() {
    ...
    return (
        <>
        <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="All products">
        {/* Product Start */}
                        ...
                        <div className="row">
                                ...
                                <div className="product__all-single">
                                    ...
                                    <div className="product__all-content">
                                        <div className="product__all-title-box">
                                            <h4 className="product__all-title"><Link href="urun-detay">Lather Bag</Link>
                                            </h4>
                            ...
                            <div className="col-xl-4 col-lg-4 col-md-6">
                                <div className="product__all-single">
                                    ...
                                    <div className="product__all-content">
                                        <div className="product__all-title-box">
                                            <h4 className="product__all-title"><Link href="urun-detay">Eye Castal</Link>
                                            </h4>
                            ...
                            <div className="col-xl-4 col-lg-4 col-md-6">
                                <div className="product__all-single">
                                    ...
                                    <div className="product__all-content">
                                        <div className="product__all-title-box">
                                            <h4 className="product__all-title"><Link href="urun-detay">High Heel
                                                    Baby</Link>
                                            </h4>
                            ...
                            <div className="col-xl-4 col-lg-4 col-md-6">
                                <div className="product__all-single">
                                    ...
                                    <div className="product__all-content">
                                        <div className="product__all-title-box">
                                            <h4 className="product__all-title"><Link href="urun-detay">White
                                                    Shoes</Link>
                                            </h4>
                                            <p className="product__all-price">$325.00</p>
                                        </div>
                            ...
                            <div className="col-xl-4 col-lg-4 col-md-6">
                                <div className="product__all-single">
                                    ...
                                    <div className="product__all-content">
                                        <div className="product__all-title-box">
                                            <h4 className="product__all-title"><Link href="urun-detay">Black
                                                    Jacket</Link>
                                            </h4>
                            ...
                            <div className="col-xl-4 col-lg-4 col-md-6">
                                <div className="product__all-single">
                                    ...
                                    <div className="product__all-content">
                                        <div className="product__all-title-box">
                                            <h4 className="product__all-title"><Link href="urun-detay">Diamond
                                                    Ring</Link>
                                            </h4>
                            ...
                            <div className="col-xl-4 col-lg-4 col-md-6">
                                <div className="product__all-single">
                                    ...
                                    <div className="product__all-content">
                                        <div className="product__all-title-box">
                                            <h4 className="product__all-title"><Link href="urun-detay">Makeup Box</Link>
                                            </h4>
                            ...
                            <div className="col-xl-4 col-lg-4 col-md-6">
                                <div className="product__all-single">
                                    ...
                                    <div className="product__all-content">
                                        <div className="product__all-title-box">
                                            <h4 className="product__all-title"><Link href="urun-detay">Sofa With
                                                    Balish</Link>
                                            </h4>
                            ...
                            <div className="col-xl-4 col-lg-4 col-md-6">
                                <div className="product__all-single">
                                    ...
                                    <div className="product__all-content">
                                        <div className="product__all-title-box">
                                            <h4 className="product__all-title"><Link href="urun-detay">Baby
                                                    Sunglass</Link>
                                            </h4>
