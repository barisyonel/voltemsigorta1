...
export default function Home() {
    ...
    return (
        ...
        <Layout
            headerStyle={1}
            footerStyle={1}
            breadcrumbTitle="Aile Sigortası"
            breadcrumbImage="/tamamlay%C4%B1c%C4%B1.png"
        >
                ...
                <div className="row">
                    <div className="col-xl-8 col-lg-7">
                        <div className="insurance-details__left">
                            ...
                            <p className="insurance-details__text-1">Voldem Sigorta Tokat, aile sigortasında kapsamlı
                                teminatları bir araya getirir. Güvenli, hızlı ve şeffaf bir süreç sunarız.</p>
                            <div className="insurance-details__img-1">
                                <img src="assets/images/hayat.png" alt=""/>
                            </div>
                            <h3 className="insurance-details__title-2">Aile Sigortası</h3>
                            <p className="insurance-details__text-2">Aile sigortası, sevdiklerinizi beklenmedik risklere
                                karşı korur. İhtiyacınıza uygun teminatlar sunuyoruz.</p>
                                ...
                                <div className="accrodion-grp faq-one-accrodion" data-grp-name="faq-one-accrodion-1">
                                    <div className={isActive.key == 1 ? "accrodion active" : "accrodion"} onClick={() => handleToggle(1)}>
                                        <div className="accrodion-title">
                                            <h4>Aile sigortası neleri kapsar?</h4>
                                        </div>
