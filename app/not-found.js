                            ...
                            <div className="col-xl-12">
                                <div className="error-page__inner">
                                    <div className="error-page__img img-bounce">
                                        <img src={cloudinaryUrl("assets/images/resources/error-page-img-1.png")} alt="Sayfa bulunamadı - Voldem Sigorta Tokat, ana sayfaya dönün" suppressHydrationWarning />
                                    </div>
