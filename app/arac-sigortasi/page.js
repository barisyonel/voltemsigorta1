...
export default function Home() {
    ...
    return (
        ...
        <Layout
            ...
            breadcrumbImage="/ara%C3%A7-kasko.png"
        >
                ...
                <div className="row">
                    <div className="col-xl-8 col-lg-7">
                        <div className="insurance-details__left">
                            ...
                            <p className="insurance-details__text-1">Voldem Sigorta Tokat, araç sigortasında kapsamlı
                            ...
                            <p className="insurance-details__text-2">Araç sigortası, trafikte karşılaşabileceğiniz riskleri
                                güvence altına alır. İhtiyacınıza uygun kasko ve zorunlu trafik çözümleri sunuyoruz.</p>
                                ...
                                <div className="accrodion-grp faq-one-accrodion" data-grp-name="faq-one-accrodion-1">
                                    <div className={isActive.key == 1 ? "accrodion active" : "accrodion"} onClick={() => handleToggle(1)}>
                                        <div className="accrodion-title">
                                            <h4>Araç sigortası neleri kapsar?</h4>
                                        </div>
