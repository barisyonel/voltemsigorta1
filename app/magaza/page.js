                                                ...
                                                <div className="product-block-one">
                                                    <div className="inner-box">
                                                        ...
                                                        <div className="lower-content">
                                                            ...
                                                            <p>$15.00</p>
                                                            <h3><Link href="/urun-detay">Hemlock Grove</Link></h3>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div className="product-block-one">
                                                    <div className="inner-box">
                                                        ...
                                                        <div className="lower-content">
                                                            ...
                                                            <p>$18.00</p>
                                                            <h3><Link href="/urun-detay">Girl of Ink &amp; Stars</Link></h3>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div className="product-block-one">
                                                    <div className="inner-box">
                                                        ...
                                                        <div className="lower-content">
                                                            ...
                                                            <p>$24.00</p>
                                                            <h3><Link href="/urun-detay">Cleaver Lands</Link></h3>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div className="product-block-one">
                                                    <div className="inner-box">
                                                        ...
                                                        <div className="lower-content">
                                                            ...
                                                            <h3><Link href="/urun-detay">Self Confidence</Link></h3>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div className="product-block-one">
                                                    <div className="inner-box">
                                                        ...
                                                        <div className="lower-content">
                                                            ...
                                                            <p>$15.00</p>
                                                            <h3><Link href="/urun-detay">World of Abstract</Link></h3>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div className="shop-sidebar">
                                        ...
                                        <div className="widget widget_popular-products">
                                            ...
                                            <div className="post-inner">
                                                <div className="post">
                                                    <figure className="image-box"><Link href="/urun-detay"><img src="/assets/images/shop/product-thumb-1.jpg" alt="" /></Link></figure>
                                                    <h5><Link href="/urun-detay">Hemlock Grove</Link></h5>
                                                ...
                                                <div className="post">
                                                    <figure className="image-box"><Link href="/urun-detay"><img src="/assets/images/shop/product-thumb-2.jpg" alt="" /></Link></figure>
                                                    <h5><Link href="/urun-detay">Cleaver Lands</Link></h5>
                                                ...
                                                <div className="post">
                                                    <figure className="image-box"><Link href="/urun-detay"><img src="/assets/images/shop/product-thumb-3.jpg" alt="" /></Link></figure>
                                                    <h5><Link href="/urun-detay">Peter Cawdron</Link></h5>
                                                    <span className="price">$24.00</span>
                                                    <ul className="rating clearfix">
                                                        <li><i className="fas fa-star" /></li>
                                                        <li><i className="fas fa-star" /></li>
